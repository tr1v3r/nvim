...
function mapping.lsp(buf)
	...
	map("<LEADER>ld", "Lspsaga show_line_diagnostics ++unfocus"):mode("n"):cr():buffer(buf):desc("lsp: Line diagnostic"):set()
	...
	map("gd", "Lspsaga goto_definition"):mode("n"):cr():silent():buffer(buf):desc("lsp: Goto definition"):set()
	map("gr", "Lspsaga finder"):mode("n"):cr():silent():buffer(buf):desc("lsp: Show reference"):set()
